package IO19.sec02_fileinputoutputstream.EX03_FileInputStream_3;
import java.io.File;
...
public class FileInputStream_3 {
	public static void main(String[] args) throws IOException{
		// 1. 입력 파일 생성
		File inFile = new File("src/main/java/IO19/sec02_fileinputoutputstream/files/FileInputStream2.txt");
		...
		str = new String(byteArray2,offset,count2,Charset.defaultCharset());
		System.out.println(str);
		is3.close();
	}
}
