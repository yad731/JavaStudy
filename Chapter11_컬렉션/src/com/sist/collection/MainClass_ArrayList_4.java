...
public class MainClass_ArrayList_4 {
	...
	public static void main(String[] args) {
		...
		/*
			...
			remove() => 삭제
			set() ==> 수정
			containsAll() => 두 개의 ArrayList에서 중복된 데이터 모으기
